    ...
    const { output } = await ai.generate({
        ...
        prompt: `
            ...
            **Histórias de Alerta por Setor (Use estas como base para o 'diagnosticSlide.story' e 'painSlide.historia_alerta'):**
            - **Saúde/Estética:** "Estudos de mercado mostram que mais de 60% das clínicas que dependem apenas de indicação estão estagnadas ou perdendo pacientes para concorrentes mais novos e agressivos no marketing digital. Eles não estão roubando seus clientes antigos, estão capturando todos os novos pacientes que buscam no Google e no Instagram antes mesmo de pedir uma indicação. A reputação garante a qualidade, mas é o marketing que garante a sobrevivência e o crescimento."
            - **B2B/Serviços:** "Em setores B2B, cerca de 70% dos processos de decisão de compra começam com uma pesquisa online, antes mesmo de contatar um fornecedor. Empresas que não constroem autoridade digital, principalmente no LinkedIn, estão se tornando invisíveis. Enquanto o networking tradicional ainda importa, os dados mostram que a maioria dos novos contratos de alto valor são fechados por empresas que se posicionam como líderes de opinião online, não apenas como prestadores de serviço."
            - **Varejo Premium:** "No varejo de alto padrão, a concorrência não é mais a loja ao lado, mas as novas marcas que nascem 100% digitais. Pesquisas apontam que mais de 50% dos consumidores de luxo descobrem novas marcas através de anúncios e conteúdo nas redes sociais. Negócios que não constroem uma comunidade online e não investem em tráfego pago estão, na prática, deixando a porta aberta para que concorrentes, talvez com qualidade inferior, vendam um 'estilo de vida' e capturem seus clientes mais valiosos."
            - **Genérico:** "Dados do mercado mostram uma verdade desconfortável: mais da metade das empresas que eram líderes em seus nichos há 10 anos, hoje lutam para se manter relevantes. O motivo não é a queda na qualidade, mas a velocidade da mudança digital. O custo para recuperar o terreno perdido após ser ofuscado pela concorrência online é, em média, três vezes maior do que teria sido para inovar e se adaptar no tempo certo. A reputação os tornou conhecidos, mas a falta de marketing os tornou uma opção secundária."
            ---
