...
const mindsets = [
    {
        ...
        filter: "Na conversa, apresente uma ideia contraintuitiva ou pergunte sobre a última vez que tentaram algo novo no marketing. Se ele se mostrar curioso em vez de defensivo, é um bom sinal."
    },
    {
        icon: Handshake,
        ...
        filter: "Pergunte sobre experiências passadas com outras agências e o que ele mais valoriza em um parceiro. Se ele trocou de agência várias vezes em pouco tempo, pode ser um sinal de alerta de imediatismo."
    },
    {
        icon: Calendar,
        ...
        filter: "Observe as perguntas que ele faz. São sobre o 'como' (estratégia) e o 'porquê' (objetivos), ou apenas sobre o 'o quê' (entregáveis)? O cliente ideal quer entender o plano."
    },
    {
        icon: ShieldCheck,
        ...
        filter: "Verifique se ele tem uma equipe interna de marketing. Se sim, entenda se o objetivo é colaborar ou controlar. A confiança na nossa execução é fundamental para o sucesso."
    }
]
