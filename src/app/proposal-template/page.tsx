  ...
  return (
    <main className="flex min-h-screen flex-col items-start p-4 sm:p-8 md:p-12">
      <div className="w-full">
        ...
        {/* Slide 2: Diagnóstico */}
        <div style={slideStyles.default} className="w-[1280px] h-[720px] mx-auto text-white shadow-2xl scale-[0.6] origin-top-left sm:scale-100 sm:origin-center sm:w-full sm:h-auto sm:aspect-video mt-8">
            <div className="p-16 flex flex-col justify-center h-full">
